...
- **Fabrizio breaks planning ties; Maeve breaks product/UX ties; Dex breaks implementation ties; Cal breaks "does it work?" ties; Reed breaks "is it readable?" ties.** Those are proposals and coordination — they do **not** land on `main` without a founder merge (Nosh or Fabrizio).
- **Nosh or Fabrizio merges.** Final say on PRs to `main` is founder merge authority — Nosh or Fabrizio. Other agents open scoped PRs; they do not merge unless Nosh or Fabrizio explicitly authorizes that PR. See [`pr-discipline.md`](pr-discipline.md).
